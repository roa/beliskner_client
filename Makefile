...
OBJ_DEBUG = $(OBJDIR_DEBUG)/src/BaseRoot.o $(OBJDIR_DEBUG)/src/FrameListener.o $(OBJDIR_DEBUG)/src/InputHandler.o $(OBJDIR_DEBUG)/src/main.o

OBJ_RELEASE = $(OBJDIR_RELEASE)/src/BaseRoot.o $(OBJDIR_RELEASE)/src/FrameListener.o $(OBJDIR_RELEASE)/src/InputHandler.o $(OBJDIR_RELEASE)/src/main.o
