...
OBJ_DEBUG = $(OBJDIR_DEBUG)/src/base/Player.o $(OBJDIR_DEBUG)/src/scenes/WorldScene.o $(OBJDIR_DEBUG)/src/scenes/FightScene.o $(OBJDIR_DEBUG)/src/net/Connection.o $(OBJDIR_DEBUG)/src/base/main.o $(OBJDIR_DEBUG)/src/base/SceneManager.o $(OBJDIR_DEBUG)/src/base/BaseRoot.o $(OBJDIR_DEBUG)/src/base/Monster.o $(OBJDIR_DEBUG)/src/base/FrameListener.o $(OBJDIR_DEBUG)/src/base/DemoApp.o

OBJ_RELEASE = $(OBJDIR_RELEASE)/src/base/Player.o $(OBJDIR_RELEASE)/src/scenes/WorldScene.o $(OBJDIR_RELEASE)/src/scenes/FightScene.o $(OBJDIR_RELEASE)/src/net/Connection.o $(OBJDIR_RELEASE)/src/base/main.o $(OBJDIR_RELEASE)/src/base/SceneManager.o $(OBJDIR_RELEASE)/src/base/BaseRoot.o $(OBJDIR_RELEASE)/src/base/Monster.o $(OBJDIR_RELEASE)/src/base/FrameListener.o $(OBJDIR_RELEASE)/src/base/DemoApp.o
...
$(OBJDIR_DEBUG)/src/net/Connection.o: src/net/Connection.cpp
	$(CXX) $(CFLAGS_DEBUG) $(INC_DEBUG) -c src/net/Connection.cpp -o $(OBJDIR_DEBUG)/src/net/Connection.o
...
$(OBJDIR_RELEASE)/src/net/Connection.o: src/net/Connection.cpp
	$(CXX) $(CFLAGS_RELEASE) $(INC_RELEASE) -c src/net/Connection.cpp -o $(OBJDIR_RELEASE)/src/net/Connection.o
