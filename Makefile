...
INC_DEBUG =  $(INC) -Isrc/base -Isrc/scenes
CFLAGS_DEBUG =  $(CFLAGS) -g
RESINC_DEBUG =  $(RESINC)
RCFLAGS_DEBUG =  $(RCFLAGS)
LIBDIR_DEBUG =  $(LIBDIR)
LIB_DEBUG = $(LIB) -lOgreMain -lOIS -llua -lCEGUIBase -lCEGUIOgreRenderer
...
OBJ_RELEASE = $(OBJDIR_RELEASE)/src/scenes/WorldScene.o $(OBJDIR_RELEASE)/src/scenes/FightScene.o $(OBJDIR_RELEASE)/src/base/main.o $(OBJDIR_RELEASE)/src/base/SceneManager.o $(OBJDIR_RELEASE)/src/base/Player.o $(OBJDIR_RELEASE)/src/base/BaseRoot.o $(OBJDIR_RELEASE)/src/base/Monster.o $(OBJDIR_RELEASE)/src/base/FrameListener.o $(OBJDIR_RELEASE)/src/base/DemoApp.o
